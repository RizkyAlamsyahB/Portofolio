                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">Web Development &middot; Front-end &middot; Back-end</div>
                            </div>
                            <div class="fs-3 fw-light text-muted">Hi, I'm Rizky Alamsyah </div>
                            <h1 class="display-3 fw-bolder mb-5">
                                <span class="text-gradient d-inline">Full Stack Web Developer</span>
                            </h1>

                            <div
                                class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="{{asset('assets/cv/CV Rizky Alamsyah Bimantara.pdf.pdf')}}" download="CV Rizky Alamsyah Bimantara.pdf">Download CV</a>
                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="{{ asset('assets/Me.png') }}" alt="..." />
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="lead fw-light mb-4">Hello, I'm Rizky Alamsyah Bimantara, a Full Stack Web
                                Developer with a
                                background in Information Systems from the Universitas Pembangunan Nasional Veteran Jawa
                                Timur. I have a deep passion for crafting digital solutions that not only meet technical
                                requirements but also contribute to business growth.</p>
                            <p class="text-muted">My journey in web development includes several projects that have
                                strengthened my understanding of both front-end and back-end technologies. I continually
                                strive to unearth my potential and pursue innovation in every step. Interested in the
                                field of System Analysis, I see it as a foundation for comprehending system complexity
                                and creating more effective solutions.</p>
                            <p class="text-muted">I believe that developing applications is not just about writing code
                                but also about solving problems with a systematic approach. My interest in System
                                Analysis guides me in developing applications that align better with business
                                objectives.</p>
                            <p class="text-muted">Let's explore potential and new ideas together. I am always
                                enthusiastic about getting involved in exciting projects and building relevant
                                solutions. Feel free to browse my portfolio to see the latest projects I've developed.
                            </p>
                            <div class="d-flex justify-content-center fs-2 gap-4">
                                <a class="text-gradient" href="https://www.instagram.com/rizkyalamsyahb/"><i
                                        class="bi bi-instagram"></i></a>
                                <a class="text-gradient"
                                    href="https://www.linkedin.com/in/rizky-alamsyah-559130247/"><i
                                        class="bi bi-linkedin"></i></a>
                                <a class="text-gradient" href="https://github.com/RizkyAlamsyahB"><i
